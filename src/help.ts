...
const sections: Section[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['PROG CHANGE', L('Pick a visual: pad 1 From the code, 2 Lime, 3 Pulse, 4 Tunnel, 5 Cells, 6 Echo, 7 and 8 webcam', 'Elegir visual: pad 1 Del código, 2 Lima, 3 Pulso, 4 Túnel, 5 Celdas, 6 Eco, 7 y 8 webcam')],
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      {
        kind: 'table',
        head: [L('Control', 'Control'), L('With the "MPK Mini" pattern', 'Con el patrón "MPK Mini"')],
        rows: [
          ['Knob 1', L('Piano echo (same message as the joystick up)', 'Eco del piano (el mismo mensaje que el joystick hacia arriba)')],
          ['Knob 2', L('Piano filter: dark to bright', 'Filtro del piano: de apagado a brillante')],
          ['Knob 3', L('Piano reverb', 'Reverb del piano')],
          ['Knob 4', L('Volume of the backing beat (starts at 0)', 'Volumen del ritmo de fondo (empieza en 0)')],
          ['Knob 5', L('How many mirrors the visual has', 'Cuántos espejos tiene el visual')],
          ['Knob 6', L('How fast the visual spins', 'Lo rápido que gira el visual')],
          ['Knob 7–8', L('Free', 'Libres')],
