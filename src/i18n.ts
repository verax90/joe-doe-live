...
const strings = {
  en: {
    ...
    openCode: 'Open code (.js)',
    codeOpened: 'Opened {name}. ↶ brings back what you had.',
    codeOpenFailed: 'Could not read {name}.',
    codeHeader: '{date} · open it with More → Open code, or paste it into strudel.cc',
    ...
    learn: 'Learn',
    learnProgress: 'Step {n} of {total}',
    learnTry: '▶ Try it',
    learnYourTurn: 'Your turn:',
    learnPrevious: '← Previous',
    learnNext: 'Next →',
    compose: 'Compose',
    composeHelp:
      'Build a song layer by layer without writing code. Every button writes a line into the code, in the same key and tempo, so it always fits: watch the code to learn what each layer does.',
    composeStyle: 'Style',
    composeKey: 'Key',
    composeNew: 'Start from scratch',
    composeSurprise: 'Surprise me',
    composeChords: 'Other chords',
    composeAdd: 'Add',
    composeAnother: 'Another',
    composeMute: 'Mute',
    composeUnmute: 'Unmute',
    ...
    youtubeHelp:
      'Paste YouTube links (one per line) or a playlist link: they play muted, one after another and looping, behind the code and the visuals. Effects and the ASCII filter do not touch it and recordings leave it out (YouTube does not let pages read its picture); for that, capture its tab below. If it says the video is unavailable, its owner does not allow embedding: try another one.',
    ...
    youtubeMany: '{count} videos behind, one after another, and round again.',
    youtubeList: 'The YouTube list plays behind, and round again.',
    youtubePlaceholder: 'One link per line, or a YouTube playlist link',
    videoSourceTitle: 'With effects',
    videoSourceHelp:
      'The webcam visuals can take videos of yours (pick several: they play in turn, looping) or a browser tab instead of the camera, with every effect, the ASCII filter and recording. For YouTube with effects, open it in another tab and capture that tab.',
    videoFile: 'Your videos',
    videoTab: 'Capture a tab',
    videoWebcam: 'Back to the webcam',
    videoUsingFile: 'Webcam visuals now show {name}.',
    videoUsingFiles: 'Webcam visuals now show {count} videos in turn, looping: {names}.',
    ...
    dropHere: 'Drop your samples here, or a .js to open it',
    midiHelp:
  ...
  es: {
    ...
    openCode: 'Abrir código (.js)',
    codeOpened: 'Abierto {name}. ↶ recupera lo que tenías.',
    codeOpenFailed: 'No se pudo leer {name}.',
    codeHeader: '{date} · ábrelo con Más → Abrir código, o pégalo en strudel.cc',
    ...
    learn: 'Aprender',
    learnProgress: 'Paso {n} de {total}',
    learnTry: '▶ Probar',
    learnYourTurn: 'Te toca:',
    learnPrevious: '← Anterior',
    learnNext: 'Siguiente →',
    compose: 'Componer',
    composeHelp:
      'Monta una canción capa a capa sin escribir código. Cada botón escribe una línea en el código, en el mismo tono y tempo, así que siempre encaja: mira el código para aprender qué hace cada capa.',
    composeStyle: 'Estilo',
    composeKey: 'Tono',
    composeNew: 'Empezar de cero',
    composeSurprise: 'Sorpréndeme',
    composeChords: 'Otros acordes',
    composeAdd: 'Añadir',
    composeAnother: 'Otra',
    composeMute: 'Silenciar',
    composeUnmute: 'Activar',
    composeRemove: 'Quitar',
    ...
    youtubeHelp:
      'Pega enlaces de YouTube (uno por línea) o el de una lista: suenan en silencio, uno tras otro y en bucle, detrás del código y de los visuales. Los efectos y el filtro ASCII no le afectan y no sale en las grabaciones (YouTube no deja leer su imagen); para eso, captura su pestaña aquí abajo. Si dice que el vídeo no está disponible, su autor no deja incrustarlo: prueba con otro.',
    ...
    youtubeMany: '{count} vídeos de fondo, uno detrás de otro, y vuelta a empezar.',
    youtubeList: 'La lista de YouTube suena de fondo, y vuelta a empezar.',
    youtubePlaceholder: 'Un enlace por línea, o el enlace de una lista de YouTube',
    videoSourceTitle: 'Con efectos',
    videoSourceHelp:
      'Los visuales de webcam pueden usar vídeos tuyos (elige varios: pasan seguidos y en bucle) o una pestaña del navegador en vez de la cámara, con todos los efectos, el filtro ASCII y la grabación. Para YouTube con efectos, ábrelo en otra pestaña y captura esa pestaña.',
    videoFile: 'Tus vídeos',
    videoTab: 'Capturar una pestaña',
    videoWebcam: 'Volver a la webcam',
    videoUsingFile: 'Los visuales de webcam muestran ahora {name}.',
    videoUsingFiles: 'Los visuales de webcam muestran ahora {count} vídeos seguidos, en bucle: {names}.',
    ...
    dropHere: 'Suelta aquí tus samples, o un .js para abrirlo',
    midiHelp:
